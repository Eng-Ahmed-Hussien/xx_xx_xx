...
const Projects = () => {
  ...
  return (
    <>
      <section id="projects" className="bg-[#0A0F1F] scroll-mt-18">
        <div className=" pb-16 md:pb-20">
          <div className="container mx-auto px-[5%]">
            {/* Header */}
            <div className="w-full" data-aos="fade-down">
              <h4 className="words text-3xl py-10">Projects</h4>
            </div>
            {/* Quote */}
            <div className="w-full mb-8 md:mb-10" data-aos="fade-up">
              <div className="text-center px-4">
                <p className="text-gray-300 text-base md:text-lg italic leading-relaxed max-w-3xl mx-auto">
                  Discover my latest projects showcasing creativity, innovation,
