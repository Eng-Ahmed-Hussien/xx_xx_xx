        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-[5%] flex flex-col items-center">
          ...
          <div className="w-full mb-8 md:mb-10" data-aos="fade-up">
            <div className="text-center px-4">
              <p className="text-gray-300 text-base md:text-lg italic leading-relaxed max-w-3xl mx-auto">
                "The Skills, Tools And Technology I Use To Build Modern Web
                Applications"
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center flex-col w-full text-white text-lg sm:text-[20px] pb-16 sm:pb-20">
            <div className="flex flex-col items-center gap-4 sm:gap-6 mt-6 sm:mt-10">
              ...
              <div
                className="flex justify-center gap-2 sm:gap-4 flex-wrap max-w-full"
                data-aos="fade-down"
                data-aos-delay="100"
              >
                <FaHtml5
              ...
              {/* Row 2 - (5 skills) */}
              <div
                className="flex justify-center gap-3 sm:gap-6 flex-wrap max-w-full"
                data-aos="fade-down"
                data-aos-delay="200"
              >
                <TbBrandRedux
              ...
              {/* Row 3 - (4 skills) */}
              <div
                className="flex justify-center gap-4 sm:gap-8 flex-wrap max-w-full"
                data-aos="fade-down"
                data-aos-delay="300"
              >
                <SiIonic
              ...
              <div
                className="flex justify-center gap-6 flex-wrap max-w-full"
                data-aos="fade-down"
                data-aos-delay="600"
              >
                <VscVscode
