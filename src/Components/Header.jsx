      ...
      <div className={`container mx-auto px-[5%]`}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 justify-between">
          <div className="flex items-center ">
            <div data-aos="fade-right">
              ...
              <p className="text-white mb-5">
                Passion Creating Beautiful And Responsive Design
              </p>
          ...
          <div className="flex justify-end items-center" data-aos="fade-left">
            <img
              className=" w-[80%] lg:w-[75%] xl:w-[60%] mx-auto h-full object-cover z-10 rounded-3xl transition duration-500   shadow-2xl shadow-[#4A90E2]/20 hover:shadow-[#FF6F91]/20 cursor-pointer"
              src={myPhoto2}
              alt="Image-Error"
              loading="lazy"
            />
        ...
        <div className="flex justify-end">
          <div className="text-white fixed bottom-5 z-100">
            <div className="flex">
              {downBar && (
                <a href="https://linkedin.com/in/ahmed-hussien-front-end-developer/">
                  <FaLinkedin
              ...
              {downBar && (
                <a href="mailto:ahmedHussien1352@gmail.com">
                  <MdEmail
            ...
            <div className="flex">
              {downBar && (
                <a href="https://wa.me/201098909476?text=Hello%20Ahmed!">
                  <FaWhatsapp
