                ...
                <div>
                    ...
                    <div className="flex gap-10 mt-15">
                        <div className="flex flex-col" data-aos="fade-down">
                            ...
                            <a className='text-blue-500 mt-2' href="mailto:ahmedHussien1352@gmail.com">Official Mail</a>
                        </div>
                        <div className="flex flex-col" data-aos="fade-down">
                            <span className='text-white text-2xl'>Social Media</span>
                            <div className="flex gap-3 mt-2">
                                <a href="https://www.linkedin.com/in/ahmed-hussien-front-end-developer/" target='_blank'><FaLinkedin className='text-white hover:text-[#0A66C2] transition duration-300' size={20}/></a>
                                <a href="https://wa.me/201098909476?text=Hello%20Ahmed!" target='_blank'><FaWhatsapp className='text-white hover:text-[#25D366] transition duration-300' size={20}/></a>
                                <a href="https://www.facebook.com/ahmed.hussien.282071" target='_blank'><FaFacebook className='text-white hover:text-[#1877F2] transition duration-300' size={20} /></a>
                                <a href="https://t.me/moody1352" target='_blank'><FaTelegramPlane className='text-white hover:text-[#0088cc] transition duration-300' size={20}/></a>
                                <a href="https://github.com/Eng-Ahmed-Hussien" target='_blank'><FaGithub className='text-white' size={20}/></a>
                            </div>
                        </div>
                    </div>
                </div>
